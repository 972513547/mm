...
from .captcha import get_validate_by_2captcha, get_validate_by_ttocr
...
async def get_token_by_captcha(url: str,use_2captcha: bool) -> str | bool:
    ...
    try:
        ...
        if use_2captcha:
            ...
            log.info("尝试使用ttocr获取token")
            geetest_data = await get_validate_by_ttocr(gt, challenge ,url)
        params = {
...
async def get_token(uid: str,use_2captcha: bool) -> str | bool:
    """获取TOKEN"""
    try:
